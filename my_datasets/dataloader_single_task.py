...
from .dataloader import MySimpleDataset, MySimpleDataLoader
from .metrics import METRICS, evaluate

class MySingleTaskData(object):

    def __init__(self, logger, args, data_path, data_type, is_training, verbose=True, task_name=None):
        ...
        self.task_name = task_name if task_name else "_".join(self.data_path.split("/")[-1].split("_")[:-3])
        self.task_prefix = "_".join(self.data_path.split("/")[-1].split("_")[:-1])
    ...
    def load_dataset(self, tokenizer, do_return=False):
        ...
        if self.load and os.path.exists(preprocessed_path):
            ...
            for dp in self.data:
                ...
                outputs.append([" " + item for item in dp[1]]) # is a list
        ...
        self.dataset = MySimpleDataset(input_ids, attention_mask,
                                        decoder_input_ids, decoder_attention_mask,
